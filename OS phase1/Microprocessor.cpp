...
int main()
{
    ...
    cout<<endl;
      cout<<"\t\t\t\t========================================================================="<<endl;
      cout<<"\t\t\t\t-------------------------------------------------------------------------"<<endl;
      cout<<"\t\t\t\t****************  M I C R O P R O C E S S O R    ********************"<<endl;
      cout<<"\t\t\t\t-------------------------------------------------------------------------"<<endl;
      cout<<"\t\t\t\tPROJECT BUILT BY : "<<endl;
      cout<<"\t\t\t\t 				 Snehal Mane (B.Tech VIT Pune)				      "<<endl;
      cout<<endl;
      cout<<"\t\t\t\t========================================================================="<<endl;
...
void VirtualMachine :: AD(int address)
{
     int block,row;
    if (address > 99 or address < 0)
    {
    ...
    stringstream addd(data1);
    int NO1 = 0; // Getting Block Address
    addd >> NO1;
    stringstream addd2(data2);
    int NO2 = 0; // Getting Block Address
    addd2 >> NO2;
  int NO3 = NO1 + NO2;
  ostringstream str1;
  str1 << NO3;
